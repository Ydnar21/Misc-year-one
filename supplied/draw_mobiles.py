...
import mobiles_stu as mob  # this is the student's module
...
def main():
    ...
    if len(sys.argv) != 2:
        print("Usage: python3 ", sys.argv[0], "mobile-file")
        sys.exit(1)
    ...
    input( "Press the Enter key in this window to quit ")
    #tt.done() # did not work due to multiple tk windows
    return
